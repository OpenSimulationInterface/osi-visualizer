...
/// @brief
///
#ifndef OSI_VISUALIZER_MAIN_WINDOW_H
#define OSI_VISUALIZER_MAIN_WINDOW_H
#ifdef _WIN32
...
class MainWindow : public QMainWindow
{
  ...
  signals:
    ...
    void ConnectRequested(const QString& ipAddress, const QString& port, const DataType dataType);

    void ConnectRequested2(const QString& ipAddress, const QString& port, const DataType dataType);

    void StartPlaybackRequested(const QString& fileName, const DataType dataType);

    void StartPlaybackRequested2(const QString& fileName, const DataType dataType);
...
#endif  // OSI_VISUALIZER_MAIN_WINDOW_H
